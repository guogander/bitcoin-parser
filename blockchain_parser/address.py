...
class Address(object):
    ...
    def from_public_key(cls, public_key):
        """Constructs an Address object from a public key  从公钥构造地址对象"""
    ...
    def from_ripemd160(cls, hash, type="normal"):
        ...
        type to 'p2sh'  从RIPEMD-160散列构造一个Address对象，它可能是
普通地址或P2SH地址，后者通过将type设置为“P2SH”来指示"""
    ...
    def address(self):
        ...
        返回此地址的编码表示形式。如果是SegWit，则使用bech32编码，否则使用base58
        """
